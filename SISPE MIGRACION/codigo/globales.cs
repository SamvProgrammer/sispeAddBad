...
class globales
{
    ...
    public static void reportes(string nombreReporte,string tablaSetNombre,object[] objeto,bool imprimir = false) {
       herramientas.reportes(nombreReporte,tablaSetNombre,objeto,imprimir);
    }
}
